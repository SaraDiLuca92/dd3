...
*/
let numeri = [1, 10];
ilpiùgrande = Math.max(...numeri);
console.log(ilpiùgrande);
...
let n1 = 0;
if (n === 8) {
  console.log("n è uguale a 8");
}
if (n1 === 8) {
  console.log("n1 è uguale a 8");
}
if (n + n1 === 8) {
  console.log("La somma di n e n1 è uguale a 8");
}
if (n - n1 === 8) {
  console.log("La sottrazione tra n ed n1 è uguale a 8");
}
...
*/
let utente1 = (maglia = 10);
pantalone = 20;
maglione = 10;
let totalShoppingCart = maglia + pantalone + maglione;
console.log(totalShoppingCart);
spedizione = totalShoppingCart + 10;
if (totalShoppingCart > 50) {
  console.log(totalShoppingCart, "Spedizone Gratuita");
} else {
...
*/
let numerii = [100, 3, 8, 2];
numerii.sort(function (a, b) {
  return b - a;
});
console.log(numerii);
